...
# Full credit to https://github.com/leonsim/simhash
...
def _hashfunc(x):
    return int(hashlib.blake2b(x).hexdigest(), 16)


class Simhash(object):

    def __init__(
        self, value, f=512, reg=r'[\w\u4e00-\u9fcc]+', hashfunc=None, log=None
    ):
        """
...
class SimhashIndex(object):
    ...
    def __init__(self, objs, f=512, k=2, log=None):
        """
